...
import { TextField, Button, Container, Typography, Snackbar, Alert, InputLabel, Select, MenuItem } from '@mui/material';
  ...
  const handleRegisterWithGoogle = async () => {
    try {
      ...
      await setDoc(userDocRef, {
        ...
        type: 'driver', // Tipo de usuario por defecto
        ...userData,
      });
      ...
      // Redireccionar al DriverDashboard después del registro exitoso
